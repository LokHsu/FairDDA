...
def train_unify_mi(sens_enc, inter_enc, e_xu, e_xi, dataset, u_sens,
    ...
    for epoch in range(args.num_epochs):
        ...
        for user in range(n_users):
            ...
            scores_1=F.sigmoid(torch.matmul(e_bu[user],e_bi[item_list_pos].t()))
            scores_2=F.sigmoid(torch.matmul(e_zu[user],(e_zi[item_list_pos]).t()))
        ...
        print(len(train_u2i_cp[0]))
        print(len(train_u2i[0]))
        print(len(train_u2i_cp[1]))
        print(len(train_u2i[1]))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='./data/ijcai/process/process.pkl')
    ...
    parser.add_argument('--log_path', type=str, default='logs/aug_ib/ijcai/ijcai_')
    parser.add_argument('--param_path', type=str, default='param/aug_ib/ijcai/ijcai_')
    parser.add_argument('--pretrain_path', type=str, default='./param/ijcai/base/gcn_base_ijcai.pth')
    parser.add_argument('--bpr_reg', type=float, default=0.1)
    parser.add_argument('--lareg', type=float, default=0.05)
    parser.add_argument('--ib_reg', type=float, default=100.0)
